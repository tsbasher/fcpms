                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" name="name" id="name"
                                placeholder="Enter Bill Name" value="{{ old('name') }}">
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" required name="boq_version_id" id="boq_version_id"
                                        placeholder="Enter BOQ Version">
                                        <option value="">Select BOQ Version</option>
                                        @foreach ($boq_versions as $version)
                                            <option value="{{ $version->id }}"
                                                @if (old('boq_version_id') == $version->id) selected @endif>{{ $version->name }} ({{ date('d F, Y', strtotime($version->version_date)) }})
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bill_no" id="bill_no"
                                        placeholder="Enter Bill No" value="{{ old('bill_no') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="reference_code" id="reference_code"
                                        placeholder="Enter Refference Code" value="{{ old('reference_code') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control datepicker" name="bill_date"
                                        id="bill_date" placeholder="Enter Bill Date" value="{{ old('bill_date') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker" name="measurement_from_date"
                                        ...
                                        value="{{ old('measurement_from_date') }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" multiple name="schemes[]" id="schemes"
                                ...
                                @foreach ($schemes as $scheme)
                                    <option value="{{ $scheme->id }}" @if (old('schemes') && in_array($scheme->id, old('schemes'))) selected @endif>
