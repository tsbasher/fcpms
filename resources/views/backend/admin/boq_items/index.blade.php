            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.boq_items.create') }}" class="btn btn btn-secondary"><i
                        ...
                        <table class="table table-bordered table-hover table-head-fixed" id="boq-item-table">
                            ...
                            <tbody>
                                @foreach ($boq_items as $item)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $item->boq_parts ? $item->boq_parts->code . '.' . $item->boq_parts->name : '' }}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.boq_items.edit', $item->id) }}"
                                                class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-sm btn-danger delete_record"
                                                data-url="{{ route('admin.boq_items.destroy', $item->id) }}"><i
