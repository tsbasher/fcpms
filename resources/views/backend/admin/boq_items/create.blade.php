        ...
        <div class="row">
            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    <h3 class="card-title">Add New BOQ Item</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{ route('admin.boq_items.store') }}"
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="name" id="name"
                                        placeholder="Enter BOQ Item Name" value="{{ old('name') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="code" id="code"
                                        placeholder="Enter BOQ Item Code" value="{{ old('code') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="pile_type" id="pile_type" class="form-control select2" required>
                                        <option value="NA" @if (old('pile_type') == 'NA') selected @endif>Not
                                            Applicable</option>
                                        <option value="PC" @if (old('pile_type') == 'PC') selected @endif>Pre-Cast
                                        </option>
                                        <option value="CIS" @if (old('pile_type') == 'CIS') selected @endif>
                                            Cust-in-Situ</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="has_sub_items" name="has_sub_items"
                                value="1" @if (old('has_sub_items', 0) == 1) checked @endif>
