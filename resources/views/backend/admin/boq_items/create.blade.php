...
<section class="content">
    <div class="row">
        ...
        <div class="card card-body bg-gray-light">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{ route('admin.boq_items.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select required class="form-control select2" name="boq_part_id" id="boq_part_id" placeholder="Enter BOQ Part" required>
                                    ...
                                    @foreach ($boq_parts as $boq_part)
                                        <option value="{{ $boq_part->id }}" @if (old('boq_part_id') == $boq_part->id) selected @endif>{{ $boq_part->code }}.{{ $boq_part->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="name" id="name" placeholder="Enter BOQ Item Name" value="{{ old('name') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="code" id="code" placeholder="Enter BOQ Item Code" value="{{ old('code') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="specification_no" id="specification_no" placeholder="Enter BOQ Item Specification No" value="{{ old('specification_no') }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="has_sub_items" name="has_sub_items" value="1" @if (old('has_sub_items', 0)==1) checked @endif>
