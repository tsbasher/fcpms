            ...
            <div class="row">
                    ...
                    <div class="card card-body bg-gray-light">
                        <div class="card-header">
                            <h3 class="card-title">Add New Document Type</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('admin.document_types.store') }}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" name="name" id="name" placeholder="e.g. Work Order" value="{{ old('name') }}">
                                        </div>
                                    </div>
                                </div>
