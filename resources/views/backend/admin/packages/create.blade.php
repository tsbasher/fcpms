...
<section class="content">
    <div class="row">
        ...
        <div class="card card-body bg-gray-light">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{ route('admin.packages.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="name" id="name" placeholder="Enter Package Name" value="{{ old('name') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="contract_title" id="contract_title" placeholder="Enter Contract Title" value="{{ old('contract_title') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="alias" id="alias" placeholder="Enter Package Alias" value="{{ old('alias') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="boq_type" id="boq_type">
                                    <option value="NONEGP" {{ old('boq_type') == 'NONEGP' ? 'selected' : '' }}>NONEGP</option>
                                    <option value="EGP" {{ old('boq_type') == 'EGP' ? 'selected' : '' }}>EGP</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="code" id="code" placeholder="Enter Package Code" value="{{ old('code') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="bid_invitation_date" id="bid_invitation_date" placeholder="Enter Package Bid Invitation Date" value="{{ old('bid_invitation_date') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="bid_submission_date">Package Bid Submission Date</label>
                                <input type="text" class="form-control datepicker" name="bid_submission_date" id="bid_submission_date" placeholder="Enter Package Bid Submission Date" value="{{ old('bid_submission_date') }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="planned_start_date" id="planned_start_date" placeholder="Enter Package Planned Start Date" value="{{ old('planned_start_date') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="planned_end_date" id="planned_end_date" placeholder="Enter Package Planned End Date" value="{{ old('planned_end_date') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="actual_start_date">Package Actual Start Date</label>
                                <input type="text" class="form-control datepicker" name="actual_start_date" id="actual_start_date" placeholder="Enter Package Actual Start Date" value="{{ old('actual_start_date') }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="actual_end_date" id="actual_end_date" placeholder="Enter Package Actual End Date" value="{{ old('actual_end_date') }}">
                            </div>
                        </div>
