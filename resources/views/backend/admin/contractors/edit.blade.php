                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="bank_account_no" id="bank_account_no" placeholder="Enter Bank Account No" value="{{ old('bank_account_no', $contractor->bank_account_no) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Enter Bank Name" value="{{ old('bank_name', $contractor->bank_name) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="branch_name" id="branch_name" placeholder="Enter Branch Name" value="{{ old('branch_name', $contractor->branch_name) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="routing_number" id="routing_number" placeholder="Enter Routing Number" value="{{ old('routing_number', $contractor->routing_number) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="bank_address" id="bank_address" placeholder="Enter Bank Address" value="{{ old('bank_address', $contractor->bank_address) }}">
                                        </div>
                                    </div>
                                </div>
