    ...
    <div class="row">
        ...
        <div class="card card-body bg-gray-light">
            <div class="card-header">
                <h3 class="card-title">Add New BOQ Sub Item</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{ route('admin.boq_sub_items.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select required class="form-control select2" name="boq_item_id" id="boq_item_id" placeholder="Enter BOQ Item" required>
                                    ...
                                    <option value="{{ $boq_item->id }}" @if (old('boq_item_id')==$boq_item->id) selected @endif>{{$boq_item->code}}.{{ $boq_item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="name" id="name" placeholder="Enter BOQ Sub Item Name" value="{{ old('name') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="specification_no" id="specification_no" placeholder="Enter BOQ Sub Item Specification No" value="{{ old('specification_no') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
